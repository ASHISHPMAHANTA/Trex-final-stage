...
var obstaclesGroup, obstacle1, obstacle2, obstacle3, obstacle4, obstacle5, obstacle6,Background,BackgroundImage,sun,sunImage;
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(width/2,height-450,40,10);
    cloud.y = Math.round(random(height-410,height-450));
...
function Sun(){
  ...
  sun = createSprite(width-50,height/5,20,20);
  sun.addImage("sun",sunImage);
  sun.depth = Background.depth;
